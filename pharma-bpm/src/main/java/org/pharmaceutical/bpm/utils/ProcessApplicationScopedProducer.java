...
@ApplicationScoped
public class ProcessApplicationScopedProducer {
    ...
    @Inject @Kjar private Instance<DeploymentService> deploymentService;
    ...
    @Produces
    public TaskLifeCycleEventListener produceBAMAuditListener() {
