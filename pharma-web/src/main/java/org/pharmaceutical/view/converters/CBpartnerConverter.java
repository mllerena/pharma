...
@ManagedBean
@ApplicationScoped
public class CBpartnerConverter implements Converter, Serializable {
...
//        return (string.trim().equals("") || string == null) ? null : objRes;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) { 
        return (o == null || o.equals("")) ? "" : ((CBpartner) o).getId() + "";
