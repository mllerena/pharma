 ...
 */
@Stateless
public class MaPlMachineFacade extends AbstractFacade<MaPlMachine> {
    ...
    public MaPlMachineFacade() {
        super(MaPlMachine.class);
    }
    
    public List<MaPlMachine> findByMProductionplanId(MProductionplan entity) {  
        List<MaPlMachine> result = null; 
        try {
            Query query = em.createNamedQuery("MaPlMachine.findByMProductionplanId");
    ...
    public void save(MaPlMachine entity) throws ExecuteRollbackException {
        try {
        	
        	if( entity == null){
        		throw new ProcessOperationException("El parámetro MaPlMachine no puede ser null.");
        	}
        ...
        /*}catch (ExistException e) {
        	throw new ExecuteRollbackException("La dirección "+ MaPlMachine.getName() +" ya ha sido asignado anteriormente.");*/
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void save(List<MaPlMachine> entityList) throws ExecuteRollbackException {
        try {
        	if( entityList == null){
        		throw new ProcessOperationException("El parámetro entityList no puede ser null.");
        	}
        	
        	for (MaPlMachine entity : entityList) {
				this.save(entity); 
			}
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void delete(MaPlMachine entity) throws ExecuteRollbackException {
        try {
        	if( entity == null ){
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED) 
    public void delete(List<MaPlMachine> entityList) throws ExecuteRollbackException {
        try {
        	if( entityList == null){
        		throw new ProcessOperationException("El parámetro MaPlMachineList no puede ser null.");
        	}
