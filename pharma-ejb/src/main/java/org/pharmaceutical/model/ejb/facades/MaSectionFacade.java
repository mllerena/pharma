 ...
 */
@Stateless
public class MaSectionFacade extends AbstractFacade<MaSection> {
    ...
    public MaSectionFacade() {
        super(MaSection.class);
    }
    
    public List<MaSection> find(MaSection filter) {

		System.out.println("filter: " + filter);

		List<MaSection> result = null;

		StringBuilder sql = new StringBuilder();
		sql.append("SELECT e FROM MaSection e ");
		sql.append("WHERE ");
		sql.append("e.maSectionId like :id ");
		sql.append("AND ");
    ...
    public MaSection findByName(String name) {
        List<MaSection> result = null;
        try {
            Query query = em.createNamedQuery("MaSection.findByName");
    ...
    public void save(MaSection entity) throws ExecuteRollbackException {
        try {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void delete(MaSection entity) throws ExecuteRollbackException {
        try {
        	if( entity == null ){
    ...
    // =============================================================
    public void validarExistencia(MaSection entity) throws ExistException {
        try {
        	MaSection temp = findByName(entity.getName());
            if (temp != null) {
    ...
    public void validarExistenciaActualizar(MaSection entity) throws ExistException {
        try {
        	MaSection entityWithNotChange = find(entity.getId());
