 ...
 */
@Stateless
public class MaPlEmployeeFacade extends AbstractFacade<MaPlEmployee> {
    ...
    public MaPlEmployeeFacade() {
        super(MaPlEmployee.class);
    }
    
    public List<MaPlEmployee> findByMProductionplanId(MProductionplan entity) {  
        List<MaPlEmployee> result = null; 
        try {
            Query query = em.createNamedQuery("MaPlEmployee.findByMProductionplanId");
    ...
    public void save(MaPlEmployee entity) throws ExecuteRollbackException {
        try {
        	
        	if( entity == null){
        		throw new ProcessOperationException("El parámetro MaPlEmployee no puede ser null.");
        	}
        ...
        /*}catch (ExistException e) {
        	throw new ExecuteRollbackException("La dirección "+ MaPlEmployee.getName() +" ya ha sido asignado anteriormente.");*/
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void save(List<MaPlEmployee> entityList) throws ExecuteRollbackException {
        try {
        	if( entityList == null){
        		throw new ProcessOperationException("El parámetro entityList no puede ser null.");
        	}
        	
        	for (MaPlEmployee entity : entityList) {
				this.save(entity); 
			}
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void delete(MaPlEmployee entity) throws ExecuteRollbackException {
        try {
        	if( entity == null ){
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED) 
    public void delete(List<MaPlEmployee> entityList) throws ExecuteRollbackException {
        try {
        	if( entityList == null){
        		throw new ProcessOperationException("El parámetro MaPlEmployeeList no puede ser null.");
        	}
