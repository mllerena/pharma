 ...
 */
@Stateless
public class MaMachineFacade extends AbstractFacade<MaMachine> {
    ...
    public MaMachineFacade() {
        super(MaMachine.class);
    }
    
    public List<MaMachine> find(MaMachine filter) {

		System.out.println("filter: " + filter);

		List<MaMachine> result = null;

		StringBuilder sql = new StringBuilder();
		sql.append("SELECT e FROM MaMachine e ");
		sql.append("WHERE ");
		sql.append("e.maMachineId like :id ");
		sql.append("AND ");
    ...
    public MaMachine findByName(String name) {
        List<MaMachine> result = null;
        try {
            Query query = em.createNamedQuery("MaMachine.findByName"); 
    ...
    public void save(MaMachine entity) throws ExecuteRollbackException {
        try {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void delete(MaMachine entity) throws ExecuteRollbackException {
        try {
        	if( entity == null ){
    ...
    // =============================================================
    public void validarExistencia(MaMachine entity) throws ExistException {
        try {
        	MaMachine temp = findByName(entity.getName());
            if (temp != null) {
    ...
    public void validarExistenciaActualizar(MaMachine entity) throws ExistException {
        try {
        	MaMachine entityWithNotChange = find(entity.getId());
