...
@NamedQueries({
    ...
    @NamedQuery(name = "CActivity.findByCActivityId", query = "SELECT c FROM CActivity c WHERE c.cActivityId = :cActivityId"),
    @NamedQuery(name = "CActivity.findByIsactive", query = "SELECT c FROM CActivity c WHERE c.isactive = :isactive"),
    @NamedQuery(name = "CActivity.findByCreated", query = "SELECT c FROM CActivity c WHERE c.created = :created"),
    @NamedQuery(name = "CActivity.findByCreatedby", query = "SELECT c FROM CActivity c WHERE c.createdby = :createdby"),
    @NamedQuery(name = "CActivity.findByUpdated", query = "SELECT c FROM CActivity c WHERE c.updated = :updated"),
    @NamedQuery(name = "CActivity.findByUpdatedby", query = "SELECT c FROM CActivity c WHERE c.updatedby = :updatedby"),
    @NamedQuery(name = "CActivity.findByValue", query = "SELECT c FROM CActivity c WHERE c.value = :value"),
    @NamedQuery(name = "CActivity.findByName", query = "SELECT c FROM CActivity c WHERE c.name = :name"),
    @NamedQuery(name = "CActivity.findByDescription", query = "SELECT c FROM CActivity c WHERE c.description = :description"),
    @NamedQuery(name = "CActivity.findByIssummary", query = "SELECT c FROM CActivity c WHERE c.issummary = :issummary"),
    @NamedQuery(name = "CActivity.findByHelp", query = "SELECT c FROM CActivity c WHERE c.help = :help")})
public class CActivity implements Serializable {
    ...
    @Column(name = "help")
    private String help;
    @OneToMany(fetch=javax.persistence.FetchType.LAZY,mappedBy = "cActivityId")
    ...
    public CActivity(String cActivityId) {
        this.cActivityId = cActivityId;
    }

    public CActivity(String cActivityId, Character isactive, Date created, String createdby, Date updated, String updatedby, String value, String name, Character issummary) {
        this.cActivityId = cActivityId;
    ...
    public int hashCode() {
        int hash = 0;
        hash += (cActivityId != null ? cActivityId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CActivity)) {
            return false;
        }
        CActivity other = (CActivity) object;
        if ((this.cActivityId == null && other.cActivityId != null) || (this.cActivityId != null && !this.cActivityId.equals(other.cActivityId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "org.pharmaceutical.model.entities.CActivity[ cActivityId=" + cActivityId + " ]";
    }
